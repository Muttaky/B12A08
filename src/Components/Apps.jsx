    ...
    return (
      ...
      {isSearching ? (
                ...
                <div className="text-center py-20">
                    <h2 className="text-2xl font-semibold text-gray-600">❌ No App Found for "{term}"</h2>
                    <p className="text-gray-500 mt-2">Try adjusting your search term or check all categories.</p>
                </div>
            ) : (
